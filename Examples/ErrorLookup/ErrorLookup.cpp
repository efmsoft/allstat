...
// ErrorLookup.cpp : Defines the class behaviors for the application.
//
...
// The one and only CErrorLookupApp object

CErrorLookupApp theApp;


// CErrorLookupApp initialization
